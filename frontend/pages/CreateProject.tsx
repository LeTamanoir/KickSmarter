import { FormControl, Input, VStack, FormLabel, Textarea, Button, Heading } from '@chakra-ui/react';
...
const SubmitStateButton = () => {
	...
	return (
		<Button isLoading={isLoading} onClick={HandleClick} colorScheme='teal' variant='solid'>
			Submitting Project
		</Button>
	);
};
