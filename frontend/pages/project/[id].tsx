...
const ProjectDesc = (): JSX.Element => {
    ...
    const [project, setProject] = useState<any>({
        name: 'Gatien la chauve',
        description: 'Gatien devrait vraiment avoir une coupe mullet',
        author: 'IsmaZebi',
        steps: [8000, 100, 10, 20000, 1000],
    });
    ...
    return (
        <>
            <VStack w="100%" mb="30px">
                <Navbar />
                <Text pt="30px" fontSize="3xl" fontWeight="bold">{project.name}</Text>
                ...
                <HStack align="start" pt="50px">
                    ...
                    <VStack w="70%" align="start" pl="50px" pt="50px">
                        ...
                        <VStack align="start" spacing="20px" pt="20px">
                            <Text><b style={{ fontSize: '25px'}}>32</b><br />days before next vote</Text>
                            <Text><b style={{ fontSize: '25px' }}>4%</b><br />negative vote at previous milestone</Text>
                        </VStack>
                    </VStack>
                </HStack>
